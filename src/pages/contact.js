                ...
                <div className="ContactRow">
                    ...
                    <div className="ContactInfo">
                        ...
                        <ul className="ContactList">
                            <li className="ContactItem"><span className="phone">Need help?</span></li>
                            <li>frank_miguel29@outlook.com</li>
                            <li className="ContactItem"><span className="phone">Do you wanna talk?</span></li>
                    ...
                    <div className="ContactMessage"> 
                        <Form>
                            ...
                            <Form.Group controlId="MessageTextField">
                                <Form.Control as="textarea" rows="10" placeholder="Type here your message.." />
                            </Form.Group>
