...
const SkillBar = (props) => {
    ...
    if (props.singleIcon) {
        element = <Container className="SkillBar">
                    <div className="BarTop">
                        <p className="BarTitle">{props.title}</p>
                        <ul className="BarIcons">
                            <li><Image src={props.firstIcon} /></li>
                        </ul>
                    </div>
                    <span className="BarContainer">
                        <span className="BarStatus" style={{width: `${props.percentage}%` }}></span>
                    </span>
                </Container>
        ...
        element = <Container className="SkillBar">
                    <div className="BarTop">
                        ...
                        <ul className="BarIcons">
                            <li><Image src={props.firstIcon} /></li>
                            <li><Image src={props.secondIcon} /></li>
                        </ul>
                    </div>
                    <span className="BarContainer">
                        <span className="BarStatus" style={{width: `${props.percentage}%` }}></span>
        ...
        element = <Container className="SkillBar">
                    <div className="BarTop">
                        ...
                        <ul className="BarIcons">
                            <li><Image src={props.firstIcon} /></li>
                            <li><Image src={props.secondIcon} /></li>
                            <li><Image src={props.thirdIcon} /></li>
                        </ul>
                    </div>
                    <span className="BarContainer">
                        <span className="BarStatus" style={{width: `${props.percentage}%` }}></span>
